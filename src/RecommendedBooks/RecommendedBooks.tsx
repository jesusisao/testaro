  ...
  return (
    <div className="RecommendedBooks">
      ...
      <div className="text-area">
        <h2>ソフトウェアテストの教科書 品質を決定づけるテスト工程の基本と実践</h2>
        <p>
        ...
        <p>
          ...
          <a href="https://www.amazon.co.jp/dp/4797365811/ref=cm_sw_r_tw_dp_x_Z9zJFbGZ46NJC">Amazonで購入する</a>
        </p>
      </div>
      ...
      <div className="text-area">
        ...
        <p>
          著者のKent Beckはアジャイルマニフェスト起案者でもあります。エクストリームプログラミングで、どうやって品質を担保していくのか、その基本的な手法を、この本で学ぶことができるかもしれません。
          <a href="https://www.amazon.co.jp/dp/4274217884/ref=cm_sw_r_tw_dp_x_AbAJFb2Z29XM2">Amazonで購入する</a>
        </p>
      </div>
    </div>
  );
