...
export const sortedUserKeys: Array<DisplayUserKey> = (Object.keys(userDisplayInfo))
  .sort(
    (a: string, b: string) => {
      if( userDisplayInfo[a as DisplayUserKey]["sortNum"] < userDisplayInfo[b as DisplayUserKey]["sortNum"] ) return -1;
      if( userDisplayInfo[a as DisplayUserKey]["sortNum"] > userDisplayInfo[b as DisplayUserKey]["sortNum"] ) return 1;
      return 0;
    }
